...
@interface FoodViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,NetworkHelperDelegate>
...
- (void)getDataFromServerWithPage:(int)page
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://apapia.manmanbuy.com/index_json.ashx?jsoncallback=?&methodName=getBCJlist&cat=meishi&page=%d", page];
