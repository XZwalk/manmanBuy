...
@interface ManViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,NetworkHelperDelegate>
...
- (void)getDataFromServerWithPage:(int)page
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://apapia.manmanbuy.com/index_json.ashx?jsoncallback=?&methodName=getBCJlist&cat=nanzhuang&page=%d", page];
