//
//  DigitalHomeAppliancesViewController.m
//  Class2509
//
...
@interface DigitalHomeAppliancesViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,NetworkHelperDelegate>
...
@implementation DigitalHomeAppliancesViewController
...
- (void)getDataFromServerWithPage:(int)page
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://apapia.manmanbuy.com/index_json.ashx?jsoncallback=?&methodName=getBCJlist&cat=shuma&page=%d", page];
