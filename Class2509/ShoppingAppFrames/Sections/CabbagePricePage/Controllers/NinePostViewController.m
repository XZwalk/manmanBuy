...
@interface NinePostViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,NetworkHelperDelegate>
...
@implementation NinePostViewController
...
- (void)getDataFromServerWithPage:(int)page
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://apapia.manmanbuy.com/index_json.ashx?jsoncallback=?&methodName=getBCJlist&cat=9p9&page=%d", page];
