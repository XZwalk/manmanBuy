...
@interface ShoeBagViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,NetworkHelperDelegate>
...
@implementation ShoeBagViewController
...
- (void)getDataFromServerWithPage:(int)page
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://apapia.manmanbuy.com/index_json.ashx?jsoncallback=?&methodName=getBCJlist&cat=xiebao&page=%d", page];
